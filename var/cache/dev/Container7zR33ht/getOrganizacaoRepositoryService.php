...
// Returns the private 'App\Repository\OrganizacaoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OrganizacaoRepository.php';

return $this->privates['App\Repository\OrganizacaoRepository'] = new \App\Repository\OrganizacaoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
