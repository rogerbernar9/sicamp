...
// Returns the private 'App\Repository\PartidaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PartidaRepository.php';

return $this->privates['App\Repository\PartidaRepository'] = new \App\Repository\PartidaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
