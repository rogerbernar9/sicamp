...
// Returns the private 'App\Repository\TimeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TimeRepository.php';

return $this->privates['App\Repository\TimeRepository'] = new \App\Repository\TimeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
