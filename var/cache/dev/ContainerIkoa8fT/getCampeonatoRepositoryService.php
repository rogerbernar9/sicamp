...
// Returns the private 'App\Repository\CampeonatoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CampeonatoRepository.php';

return $this->privates['App\Repository\CampeonatoRepository'] = new \App\Repository\CampeonatoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
